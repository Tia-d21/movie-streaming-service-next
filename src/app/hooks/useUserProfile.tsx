    ...
    try {
      ...
      if (currentUserEmail) {
        ...
        const updatedUsers = registeredUsers.filter(
          (registeredUser: UserProfile) => registeredUser.email !== currentUserEmail
        );
        
        // Save the updated list back to localStorage
        window.localStorage.setItem('registeredUsers', JSON.stringify(updatedUsers));
        console.log(`User ${currentUserEmail} has been logged out and their registration data has been removed.`);
      }
