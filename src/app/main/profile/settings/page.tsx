        ...
        <div className="bg-gray-900 rounded-lg p-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center py-2 border-b border-gray-800">
              ...
              <button
                className={`w-12 h-6 rounded-full ${
                  notification.email ? "bg-red-600" : "bg-gray-700"
                } relative`}
                onClick={() =>
                  setNotification({
                    ...notification,
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-800">
              ...
              <button
                className={`w-12 h-6 rounded-full ${
                  notification.app ? "bg-red-600" : "bg-gray-700"
                } relative`}
                onClick={() =>
                  setNotification({ ...notification, app: !notification.app })
                }
              >
                <div
                  className={`absolute w-4 h-4 rounded-full bg-white top-1 transition-all ${
                    notification.app ? "right-1" : "left-1"
                  }`}
                ></div>
              </button>
            </div>
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-800">
              ...
              <button
                className={`w-12 h-6 rounded-full ${
                  notification.newContent ? "bg-red-600" : "bg-gray-700"
                } relative`}
                onClick={() =>
                  setNotification({
                    ...notification,
              ...
              >
                <div
                  className={`absolute w-4 h-4 rounded-full bg-white top-1 transition-all ${
                    notification.newContent ? "right-1" : "left-1"
                  }`}
                ></div>
              </button>
            </div>
            ...
            <div className="flex justify-between items-center py-2 border-b border-gray-800">
              ...
              <button
                className={`w-12 h-6 rounded-full ${
                  notification.updates ? "bg-red-600" : "bg-gray-700"
                } relative`}
                onClick={() =>
                  setNotification({
                    ...notification,
              ...
              >
                <div
                  className={`absolute w-4 h-4 rounded-full bg-white top-1 transition-all ${
                    notification.updates ? "right-1" : "left-1"
                  }`}
                ></div>
              </button>
            </div>
